...
COMPLETE = '/home/monitor_db/events/data/vector/hcdm_vectors_reduced.csv'
OUTPUT = '/home/monitor_db/events/data/vector/split/'
VECTOR_SCRIPT = '/home/monitor_db/events/data/vector/split_hcdm_vector_table.sql'
...
def main():
    ...
    for i in trange(NUM_SPLITS):
        ...
        sqlstr += 'LOAD DATA LOCAL INFILE "%s" INTO TABLE %s FIELDS TERMINATED BY ",";\n\n' % (filename, tablename)
